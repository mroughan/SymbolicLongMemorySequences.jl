@testset "Validation policy and benchmark infrastructure" begin
    ...
    @test contains(benchmark_readme, "S5_BENCHMARK_SCALING")
    @test contains(benchmark_readme, "S5_BENCHMARK_SYNTH_REPEATS")
    ...
    @test contains(benchmark_script, "S5_BENCHMARK_SCALING")
    @test contains(benchmark_script, "S5_BENCHMARK_SYNTH_REPEATS")
    ...
    @test contains(benchmark_script, "S5_BENCHMARK_WRITE_RESULTS")
